...
namespace BobbleButt
{
    public static class GlobalData
    {
        ...
        static GlobalData() { productList = new List<Product>();
            ...
            userList.Add(new User("Basic", "User", "basicuser@bu.com", "10/10/10", "password", "123 Fake St", "Springfield", 2251, 0400000000, false));
            userList.Add(new User("Admin", "User", "adminuser@bobblebutt.com", "01/01/01", "password", "321 Fake St", "Springfield", 2251, 0499999999, true));
        }
    }
}